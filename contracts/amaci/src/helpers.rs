...
use crate::register_msg::RegisterExecuteMsg;
use crate::register_msg::{AdminResponse, RegisterQueryMsg};
...
impl Cw4Contract {
    ...
    pub fn admin(&self, querier: &QuerierWrapper) -> StdResult<Option<String>> {
        let query = self.encode_smart_query(RegisterQueryMsg::Admin {})?;
