...
pub fn match_vkeys(parameters: &MaciParameters) -> Result<VkeyParams, ContractError> {
        ...
        && parameters.message_batch_size == Uint256::from_u128(5)
    {
        let groth16_process_vkey = Groth16VKeyType {
            ...
            vk_ic0: "02a1c111e02d41b184ccbe0907e0b5551a21f4638b8347c2f7526e9811b031ad04b61fddf1336ae59142e13741e207758d82e74a437a973e594ef4a47c1af34f".to_string(),
        ...
        && parameters.message_batch_size == Uint256::from_u128(25)
    {
        let groth16_process_vkey = Groth16VKeyType {
            ...
            vk_gamma_2: "".to_string(),
            vk_delta_2: "".to_string(),
            vk_ic0: "259429badacae0a6dfa8e3f41dcbcaec3e7cbed1a5ed8b077fe20716d8b0b31e139a66adbd61f652fdead7be8a3304f5950503f4ab2c3e6143cd1ff2901a6920".to_string(),
